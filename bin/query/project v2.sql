...
--
-- Host: 127.0.0.1
-- Creato il: Mar 16, 2019 alle 14:44
...
(1, 'Adam', 'Min', 1, 'pass', 'adam.min@marconi.com'),
(2, 'Mario', 'Mario', 2, 'pass', 'mario.mario@marconi.com'),
(3, 'Luigi', 'Mario', 2, 'pass', 'luigi.mario@marconi.com');
...
--
ALTER TABLE `classe`
  MODIFY `idclasse` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
